...
>>> c.feeding_set.create(date='2023-01-17')
<Feeding: Breakfast on 2023-01-17>
# yup, it's there and the default of 'B' for the meal worked
>>> Feeding.objects.all()
<QuerySet [<Feeding: Breakfast on 2023-01-17>]>
...
<Cat: Penny>
>>> f.cat.description
'Cute as a Disney cat. Looks pink.'
# another way to create a feeding for a cat
>>> f = Feeding(date='2023-01-17', meal='L', cat=c)
>>> f.save()
>>> f
<Feeding: Lunch on 2023-01-17>
>>> c.feeding_set.all()
<QuerySet [<Feeding: Breakfast on 2023-01-17>, <Feeding: Lunch on 2023-01-17>]>
# finish the day's feeding, this time using the create method
>>> Feeding.objects.create(date='2023-01-17', meal='D', cat=c)
>>> c.feeding_set.count()
3
# list cat ids
...
>>> c
<Cat: Logan>
>>> c.feeding_set.create(date='2023-01-17', meal='B')
<Feeding: Breakfast on 2023-01-17>
>>> Feeding.objects.filter(meal='B')
<QuerySet [<Feeding: Breakfast on 2023-01-17>, <Feeding: Breakfast on 2023-01-17>]>
# the foreign key (cat_id) can be used as well
>>> Feeding.objects.filter(cat_id=1)
<QuerySet [<Feeding: Breakfast on 2023-01-17>, <Feeding: Lunch on 2023-01-17>, <Feeding: Dinner on 2023-01-17>]>
>>> Feeding.objects.create(date='2023-01-17', meal='L', cat_id=3)
...
<img src="https://i.imgur.com/xpH4bYQ.png">
...
<img src="https://i.imgur.com/ihXzCGR.png">
